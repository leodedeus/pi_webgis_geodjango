...
SECRET_KEY = 'django-insecure-j5o#9dd&3938t)qxri5y*34b7b61ww%3hi^k92okv58(4jkx--'
...
DATABASES = {
    'default': {
        ...
        'PORT': '5432',
        'OPTIONS': {
            'options': '-c search_path=public,camadas',
        }
    }
}
...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'app_core/pi_webgis/static/')
